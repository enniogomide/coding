			...
			@else
				...
				<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">
					...
					<ul class="dropdown-menu" role="menu">
						<li><a href="{{ url('/admin/profile') }}/{{auth()->user()->id}}">Perfil</a></li>
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="{{route('admin.users.index')}}">Todos Usuários</a>
                            </li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="{{route('admin.categories.index')}}">Listar Categorias</a>
                            </li>

                            <li>
                                <a href="{{route('admin.categories.create')}}">Nova Categoria</a>
                            </li>
